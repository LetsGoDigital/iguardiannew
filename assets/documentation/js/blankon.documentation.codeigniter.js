var BlankonDocumentationCodeigniter = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonDocumentationCodeigniter.handleHeaderDropdownMenu();
            BlankonDocumentationCodeigniter.handleSidebarLeftActive();
            BlankonDocumentationCodeigniter.handleSmoothScroll();
            BlankonDocumentationCodeigniter.handleCodePrettify();
            BlankonDocumentationCodeigniter.handleSelect2();
            BlankonDocumentationCodeigniter.handleSelect2QuickSearch();
            BlankonDocumentationCodeigniter.handleDatatableChangeLog();
        },
            ...
            $eventSelectQuickSearch.on('select2:select', function () {
                ...
                if (url) { // require a URL
                    if($('.live-preview-doc').length){
                        window.open(getBaseURL()+'/live-preview/admin/codeigniter/backend/'+url, '_blank') ; // redirect live preview
                    }else{
                        window.open(getBaseURL()+'/production/admin/codeigniter/backend/'+url, '_blank') ; // redirect templates
                    }
...
// Call main app init
BlankonDocumentationCodeigniter.init();
